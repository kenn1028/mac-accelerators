...
read_verilog ../mapped/mac_engine_mapped.v
current_design mac_engine
link_design

# Define simulation environment
set_units -time ps -resistance kOhm -capacitance fF -voltage V -current mA
create_clock -period 1538 -name CLK [get_ports clk]
read_vcd "../sim/mac_engine.dump" -strip_path "mac_engine_tb/UUT"
check_power
set_power_analysis_options -waveform_format fsdb -waveform_output vcd
update_power > pt_simulation.log
report_power -hierarchy > mac_engine_pt_power.rpt

# Exit pt_shell to run new benchmark
exit