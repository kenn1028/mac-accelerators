...
############ (Code Block for Export/Import of the Probability Distribution for faster Benchmarking) ############

# export probability distribution
np.save('mbv2_conv595_probs.npy', probs)

# # import probability distribution (to avoid sampling the same every time during benchmark)
