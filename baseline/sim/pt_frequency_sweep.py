...
for freq in freq_list:
    ...
    for prec in prec_list:
        ...
        if (prec == '2bx2b'):
            tb_data[280] = "    repeat (200) begin\n"
            tb_data[281] = "        test_precision(_2bx2b, 8'd51);\n"
            tb_data[282] = "    end\n"
            tb_data[284] = "    // repeat (200) begin\n"
            tb_data[285] = "    //     test_precision(_4bx4b, 8'd51);\n"
            tb_data[286] = "    // end\n"
            tb_data[288] = "    // repeat (200) begin\n"
        ...
        energy = (fu_power*exec_time)/20000
